...
class Videos extends BaseComponent {
    itemOffset = 0;
    featuredOffset = 0;
    myOffset = 0;
    limit = 10;
    ...
    finishedCreate(res) {
        //newly created videos should be append to browse and my video lists
        let browseLists = [];
    ...
    displayItem(item,index) {
        return (<TouchableWithoutFeedback onPress={() => {
            ...
            <Card>
                ...
                <CardItem cardBody>
                    <FastImage source={{uri: item.photo}} style={{height: 200, width: null, flex: 1}}>
                        <View style={{
                            alignSelf:'center',
            ...
            <MenuProvider customStyles={menuProviderStyles}>
                ...
                <Container>
                    <Modal
                        ...
                        <VideoCreate navigation={this.props.navigation} type="new" component={this}/>
                    </Modal>
                    <Animated.View style={{
                        width: "100%",
                        elevation: 0,
                        ...
                        <Header hasTabs>
                            ...
                            <Body >
                            <Text style={{color:'white',fontSize: 16,left:-10}}>{this.lang.t('videos')}</Text>
                            </Body>
                        ...
                        <Tabs
                            ...
                            <Tab style={{backgroundColor: '#DEDCDD'}}  heading={this.lang.t('videos').toUpperCase()} >
                                <AnimatedFlatList
                                    ...
                                    ListEmptyComponent={!this.state.fetchFinished ? (
                                        <Text/>
                                    ) : (<EmptyComponent text={this.lang.t('no_videos_found')}/>)}
                            ...
                            <Tab style={{backgroundColor: '#DEDCDD'}}  heading={this.lang.t('my_videos').toUpperCase()} >
                                <AnimatedFlatList
                                    keyExtractor={(item, index) => item.id}
