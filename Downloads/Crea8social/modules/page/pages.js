...
class Pages extends BaseComponent {
    ...
    finishedCreate(res) {
        //newly created pages should be append to browse and my page lists
        let browseLists = [];
                ...
                <CardItem>
                    <Left>
                        <View style={{flexDirection:'column'}}>
                            <Text style={{fontSize:15}}><Text style={{fontWeight:'bold',color:'black'}}>{item.likes}</Text> {this.lang.t('people_likes_page')}</Text>
            ...
            <MenuProvider customStyles={menuProviderStyles}>
                ...
                <Container>
                    <Modal
                        ...
                        <PageCreate navigation={this.props.navigation} type="new" component={this}/>
                    </Modal>
                    <Animated.View style={{
                        width: "100%",
                        elevation: 0,
                        ...
                        <Header hasTabs>
                            ...
                            <Body >
                            <Text style={{color:'white',fontSize: 16,left:-10}}>{this.lang.t('pages')}</Text>
                            </Body>
                        ...
                        <Tabs
                            ...
                            <Tab style={{backgroundColor: '#DEDCDD'}}  heading={this.lang.t('pages').toUpperCase()} >
                                <AnimatedFlatList
                                    ...
                                    ListEmptyComponent={!this.state.fetchFinished ? (
                                        <Text/>
                                    ) : (<EmptyComponent text={this.lang.t('no_pages_found')}/>)}
                            ...
                            <Tab style={{backgroundColor: '#DEDCDD'}}  heading={this.lang.t('my_pages').toUpperCase()} >
                                <AnimatedFlatList
                                    keyExtractor={(item, index) => item.id}
