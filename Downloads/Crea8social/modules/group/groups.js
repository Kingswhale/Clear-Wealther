...
class Groups extends BaseComponent {
    ...
    finishedCreate(res) {
        //newly created groups should be append to browse and my group lists
        let browseLists = [];
                ...
                <CardItem cardBody>
                    <FastImage source={{uri: item.cover}} style={{height: 200, width: null, flex: 1}}>
                        <View style={{position:'absolute', bottom:10,flexDirection:'row',left:10}}>
                            <FastImage source={{uri: item.logo}} style={{width:60,height:60,borderRadius:30,borderColor:'white',borderWidth: 4}}/>
                            <View style={{flex:1,marginLeft:10,flexDirection:'column'}}>
                                <Text style={{marginTop:10,fontSize:16,color:'white',textShadowColor: 'rgba(0, 0, 0, 0.75)',
                ...
                <CardItem>
                    <Left>
                        <View style={{flexDirection:'column'}}>
                            <Text style={{fontSize:15}}><Text style={{fontWeight:'bold',color:'black'}}>{item.members}</Text> {this.lang.t('members')}</Text>

                        </View>
                    </Left>
                    <Right>
                        <Button primary small style={{borderRadius:5}}>
                            <Text style={{color:'white', marginLeft:10,marginRight:10}}>{this.lang.t('join_group')}</Text>
                        </Button>
                    </Right>
                </CardItem>
            </Card>
            ...
            <MenuProvider customStyles={menuProviderStyles}>
                ...
                <Container>
                    <Modal
                        ...
                        <GroupCreate navigation={this.props.navigation} type="new" component={this}/>
                    </Modal>
                    <Animated.View style={{
                        width: "100%",
                        elevation: 0,
                        ...
                        <Header hasTabs>
                            ...
                            <Body >
                            <Text style={{color:'white',fontSize: 16,left:-10}}>{this.lang.t('groups')}</Text>
                            </Body>
                        ...
                        <Tabs
                            ...
                            <Tab style={{backgroundColor: '#DEDCDD'}}  heading={this.lang.t('groups').toUpperCase()} >
                                <AnimatedFlatList
                                    ...
                                    ListEmptyComponent={!this.state.fetchFinished ? (
                                        <Text/>
                                    ) : (<EmptyComponent text={this.lang.t('no_groups_found')}/>)}
                            ...
                            <Tab style={{backgroundColor: '#DEDCDD'}}  heading={this.lang.t('my_groups').toUpperCase()} >
                                <AnimatedFlatList
                                    keyExtractor={(item, index) => item.id}
